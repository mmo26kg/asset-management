...
router.get('/', authMiddleware.checkSystemAdmin, listOptionsMiddleware.listOptionsMiddleware, accountController.getAllAccounts);          // Lấy tất cả các tài khoản
router.get('/me', authMiddleware.checkLogin, sortMiddleware, accountController.getAllMyAccounts);          // Lấy tất cả các tài khoản
