...
VALUES 
    ('11111111-1111-1111-1111-111111111111', 'Alice', 'alice123', 'password123', 'premium', true, NOW(), NOW()),
    ('22222222-2222-2222-2222-222222222222', 'Bob', 'bob456', 'password456', 'basic', true, NOW(), NOW());
